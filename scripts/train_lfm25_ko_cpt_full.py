#!/usr/bin/env python
"""Full-parameter CPT for LiquidAI/LFM2.5 on Korean text-completion data."""
...
def main() -> None:
    ...
    trainer.save_model(str(output_dir / "final_full"))
    tokenizer.save_pretrained(str(output_dir / "final_full"))
