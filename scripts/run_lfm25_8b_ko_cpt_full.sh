...
if [ "${PUSH_TO_HUB:-0}" = "1" ]; then
  PUSH_ARGS=(--push-to-hub --hub-model-id "${HUB_MODEL_ID:-LLM-OS-Models/LFM2.5-8B-A1B-KO-CPT-FULL}")
fi
...
torchrun \
  ...
  scripts/train_lfm25_ko_cpt_full.py \
