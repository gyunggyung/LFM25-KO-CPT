...
- 출력: `/home/work/.data/lfm2_ko_cpt/datasets/ko_cpt_mix_full_20260627.jsonl`
...
- 어댑터: LoRA rank 64, alpha 128, `target_modules=all-linear`
- 컨텍스트: 8192
...
- 기본 step: 3000
- 저장: 100 step마다 checkpoint, 최대 5개 보존
